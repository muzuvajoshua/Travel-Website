  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        ...
        <p className="normal-case regular-18 -mt-1 mb-3 text-green-50">
          We are here for you
        </p>
          ...
          <div className="flexBetween flex-col">
            <div className='flex w-full flex-col'>
              <div className="flexBetween w-full">
                ...
                <p className="bold-16 text-green-50">98 min</p>
              </div>
              <p className="bold-20 mt-2">Focus Campsite</p>
            </div>

            <div className='flex w-full flex-col'>
              <p className="regular-16 text-gray-20">Start track</p>
              <h4 className="bold-20 mt-2 whitespace-nowrap">Makerere Uni</h4>
            </div>
          </div>
        </div>
      </div>
